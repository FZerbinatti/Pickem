package com.dreamsphere.pickem.Activities.MainActivities;
...
import com.dreamsphere.pickem.Activities.AccountActivities.RegisterActivity;
import com.dreamsphere.pickem.Activities.SettingsActivities.InfoActivity;
import com.dreamsphere.pickem.Activities.AccountActivities.LoginActivity;
import com.dreamsphere.pickem.Activities.SettingsActivities.NotificationRegionActivity;
import com.dreamsphere.pickem.Adapters.SimpleRegionRecyclerViewAdapter;
import com.dreamsphere.pickem.Adapters.SpinnerAdapter;
...
import com.dreamsphere.pickem.NotificationsService.AlarmReceiver;
import com.dreamsphere.pickem.NotificationsService.ForegroundService;
        ...
        button_save_settings_account.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (finalRegions.isEmpty()) {
                    ...
                    UserGeneralities userGeneralities = new UserGeneralities( edittext_emailaddress.getText().toString(),"", edittext_username.getText().toString().trim(), "", -1,finalRegions, "", "");
    ...
    private void saveEloTracker(){
        ...
        if (summonerName.isEmpty()){edittext_summoner_name.setError("Please Insert your Summoner Name");}else
            if (summoner_server.getCode().isEmpty()){
                ...
                //Toast.makeText(context, "Elotracker Updated !", Toast.LENGTH_SHORT).show();
